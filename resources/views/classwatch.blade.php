...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body class="player-course-chapter">
		...
		<ul id="courseplaycontent{{ $class->id }}" class="display-none">
				...
				@if($class->status == '1')
				<li  
				data-thumb-source="{{ url('images/course/'.$class->courses->preview_image) }}" data-video-source="{{ $url }}"

					data-start-at-time="{{date('H:i:s',strtotime($endtime))}}"
				
				    data-poster-source="{{ url('images/course/'.$class->courses->preview_image) }}"  data-subtitle-soruce="[
