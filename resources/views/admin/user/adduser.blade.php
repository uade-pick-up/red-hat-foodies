        ...
        <div class="panel-body">
          <form action="{{ route('user.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <label for="mobile">Mobile Number: <sup class="redstar">*</sup></label>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <label for="dob">Date of Birth:<sup class="redstar">*</sup></label>
                <div class="input-group date">
                  <div class="input-group-addon">
                    <i class="fa fa-calendar"></i>
                  </div>
                  <input type="text" value="{{ old('dob')}}" name="dob" required class="form-control pull-right" id="datepicker" placeholder="Enter your date of birth">
                </div>
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <br>
                <input type="radio" name="gender" id="ch1" value="m" required> Male
                <input type="radio" name="gender" id="ch2" value="f"> Female
                <input type="radio" name="gender" id="ch3" value="o"> Other
              </div>
              <div class="col-md-6">
                <label for="mobile">Password: <sup class="redstar">*</sup> </label>
            ...
            <div class="row">
              <div class="col-md-3">
                <label for="city_id">Country: <sup class="redstar">*</sup> </label>
              ...
              <div class="col-md-3">
                <label for="state_id">State: <sup class="redstar">*</sup> </label>
              ...
              <div class="col-md-3">
                <label for="city_id">City: <sup class="redstar">*</sup> </label>
                <select id="grand" class="form-control js-example-basic-single" name="city_id">
                  
                </select>
              </div>
              <div class="col-md-3"> 
                <label for="pin_code">Pincode/Zipcode:</sup></label>
            ...
            <div class="row">
              <div class="col-md-3">
                <label for="exampleInputSlug">User Image: <sup class="redstar">*</sup></label>
                <br>
              ...
              <div class="col-md-3"> 
                <label for="role">Select Role: <sup class="redstar">*</sup></label>
              ...
              <div class="col-md-3 display-none" id="doaboxxx">
                <label for="dob">Date of Anniversary: <sup class="redstar">*</sup></label>
            ...
            <div class="row">
              <div class="col-md-3">
                <label for="exampleInputDetails">Verified:</label> 
            ...
            <div class="row">
              <div class="col-md-12">
                <label for="exampleInputDetails">Detail:<sup class="redstar">*</sup></label>
