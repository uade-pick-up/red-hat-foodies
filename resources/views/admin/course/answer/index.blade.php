<section class="content">
  <div class="row">
    <div class="col-xs-12">
      <a data-toggle="modal" data-target="#myModalanswer" href="#" class="btn btn-info btn-sm">+ Add</a>
          ...
          <div class="panel panel-sum">
            <div class="modal-body">
              <form id="demo-form2" method="post" action="{{url('courseanswer/')}}" data-parsley-validate class="form-horizontal form-label-left">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <label  for="exampleInputTit1e">Select Question:<sup class="redstar">*</sup></label>
                    <br>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <label for="exampleInput">Add Answer:<sup class="redstar">*</sup></label>
                ...
                <div class="box-footer">
                  <button type="submit" value="Add Answer" class="btn btn-md col-md-3 btn-primary">+ Add Answer</button>
                </div>
