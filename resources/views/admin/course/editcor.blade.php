            ...
            <form action="{{route('course.update',$cor->id)}}" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  @php
                    $User = App\User::all();
                  @endphp
                  <label for="exampleInputSlug">Select User</label>
              ...
              <div class="row">
                <div class="col-md-6"> 
                  ...
                  @endphp
                  <label for="exampleInputSlug">Select Language</label>
              ...
              <div class="row">
                <div class="col-md-6">
                  <label for="exampleInputDetails">Short Details:<sup class="redstar">*</sup></label>
              ...
              <div class="row">
                <div class="col-md-6">
                  <label for="exampleInputDetails">Requirements:<sup class="redstar">*</sup></label>
                  <textarea name="requirement" rows="3" class="form-control" required >{!! $cor->requirement !!}</textarea>
                </div>
                <div class="col-md-6">
                  <label for="exampleInputDetails">Details:<sup class="redstar">*</sup></label>
              ...
              <div class="row">
                <div class="col-md-3">
                  <label for="exampleInputDetails">MoneyBack:</label>
                ...
                <div class="col-md-3">
                  ...
                  <br>
                    <label for="exampleInputSlug">Discount Price: <sup class="redstar">*</sup></label>
              ...
              <div class="row">
                <div class="col-md-6">
                  <label for="exampleInputDetails">Upload Preview Video:</label>  
                  <li class="tg-list-item"> 
                  ...
                  <div @if($cor->preview_type =="url" ) class="display-none" @endif id="document1">
                    <label for="exampleInputSlug">Upload Video: <sup class="redstar">*</sup></label>
                  ...
                  <div @if($cor->preview_type =="video") class="display-none" @endif id="document2">
                    <br>
                    <label for="exampleInputSlug">URL: <sup class="redstar">*</sup></label>
              ...
              <div class="box-footer">
                <button type="submit" class="btn btn-lg col-md-3 btn-primary">Save</button>
              </div>
