<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
      <a data-toggle="modal" data-target="#myModalabcde" href="#" class="btn btn-info btn-sm">+ Add</a>
      <br>
      <br>
          ...
          <div class="panel panel-sum">
            <div class="modal-body">
              <form id="demo-form2" method="post" action="{{ route('questionanswer.store') }}" data-parsley-validate class="form-horizontal form-label-left">
                ...
                <label class="display-none" for="exampleInputSlug">Course <span class="redstar">*</span></label>
