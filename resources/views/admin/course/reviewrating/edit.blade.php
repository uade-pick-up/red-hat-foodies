    ...
    <div class="col-xs-12">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Update Review</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <div class="form-group">
            <form id="demo-form" method="post" action="{{url('reviewrating/'.$jp->id)}}"data-parsley-validate class="form-horizontal form-label-left">
              ...
              <div class="row">
                <div class="col-md-6">
                  <label class="display-none" for="exampleInputSlug">Course</label>
                ...
                <div class="col-md-6">
                  <label class="display-none" for="exampleInputSlug">User</label>
              ...
              <div class="row">
                <div class="col-md-12">
                  <label for="Details">Review:<sup class="redstar">*</sup></label>
