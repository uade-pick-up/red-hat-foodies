<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
      <a data-toggle="modal" data-target="#myModalabcdef" href="#" class="btn btn-info btn-sm">+ Add</a>
      <br>
      <br>
    ...
    <div class="modal-dialog modal-md" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="myModalLabel">Add New Announcements</h4>
        </div>
          ...
          <div class="panel panel-sum">
            <div class="modal-body">
              <form id="demo-form2" method="post" action="{{ route('announsment.store') }}" data-parsley-validate class="form-horizontal form-label-left">
                ...
                <label class="display-none" for="exampleInputSlug">Course <span class="required" >*</span></label>
                <select name="course_id" class="form-control display-none">
                  <option value="{{ $cor->id }}">{{ $cor->title }}</option>
                </select>
            
                <label class="display-none"  for="exampleInputTit1e">User</label>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <label for="exampleInputDetails">Announcements:<sup class="redstar">*</sup></label>
