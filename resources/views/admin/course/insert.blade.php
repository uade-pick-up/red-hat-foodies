    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <div class="row">
            <div class="col-md-10">
              <h3 class="box-title">Course Insert Form</h3>
            </div>
            <div  class="col-md-2">
                <div><h4 class="admin-form-text"><a href="{{url('course')}}" data-toggle="tooltip" data-original-title="Go back" class="btn-floating"><i class="material-icons"><button class="btn btn-xs btn-success abc"> << Back</button> </i></a></h4></div>
            </div>
          </div>
        </div>
          ...
          <div class="form-group">
            <form action="{{url('course/')}}" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  <label>Subcategory:<span class="redstar">*</span></label>
                ...
                <div class="col-md-3">
                  <label for="exampleInputTit1e">User</label>
              ...
              <div class="row">
                <div class="col-md-6"> 
                  <label>Language: <span class="redstar">*</span></label>
                ...
                <div class="col-md-6">
                  <label for="exampleInputTit1e">Title: <sup class="redstar">*</sup></label>
                  <input type="title" class="form-control" name="title" id="exampleInputTitle" placeholder="Please Enter Your Title" value="">
                </div>
              </div>
              <br>
              ...
              <div class="row">
                <div class="col-md-6">
                  <label for="exampleInputTit1e">Short Detail: <sup class="redstar">*</sup></label>
                  <textarea name="short_detail" rows="3"  class="form-control" placeholder="Enter Your Detail"></textarea>
                </div>
                <div class="col-md-6">
                  <label for="exampleInputTit1e">Requirements: <sup class="redstar">*</sup></label>
              ...
              <div class="row">
                <div class="col-md-12">
                  <label for="exampleInputTit1e">Detail: <sup class="redstar">*</sup></label>
              ...
              <div class="row">
                <div class="col-md-3">
                  <label for="exampleInputDetails">Moneyback Guarantee:</label>
                ...
                <div class="col-md-3">
                  ...
                  <div class="display-none" id="pricebox">
                    <label for="exampleInputSlug">Price: <sup class="redstar">*</sup></label>
                    <input type="text" class="form-control" name="price" id="priceMain" placeholder="Please Your Enter price" value="">
        
                    <label for="exampleInputSlug">Discount Price: </label>
              ...
              <div class="row">
                <div class="col-md-6">
                  <label for="exampleInputDetails">Preview Video:</label>
                  <li class="tg-list-item">              
                  ...
                  <div class="display-none" id="document1">
                    <label for="exampleInputSlug">Upload Video:</label>
                ...
                <label>Preview Image:</label> - <p class="inline info">size: 250x150</p>

                <div class="col-md-6">
        
                  <input type="file" name="preview_image" id="image" class="inputfile inputfile-1" required />
              ...
              <div class="box-footer">
                <button type="submit" class="btn btn-lg col-md-4 btn-primary">Submit</button>
              </div>
