    ...
    <div class="col-xs-12">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Edit Course Chapter</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        <div class="box-body">
          <div class="form-group">
            <form id="demo-form" method="post" action="{{url('coursechapter/'.$cate->id)}}"data-parsley-validate class="form-horizontal form-label-left">
              ...
              <label class="display-none" for="exampleInputSlug">Course Choose</label>
              ...
              <div class="row">
                <div class="col-md-12">
                  <label for="exampleInputTit1e">Chapter Name:<span class="redstar">*</span></label>
