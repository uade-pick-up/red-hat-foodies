<form enctype="multipart/form-data" method="POST" action="{{ route('setting.store') }}">
	...
	<div class="row">
		<div class="col-md-6">
			<div class="form-group">
				<label for="exampleInputDetails">Text\Logo:</label>
		...
		<div class="col-md-6">
			<div class="row">
				...
				<div class="col-md-6">
					<div class="form-group">
						<label for="exampleInputDetails">Project Logo</label>- <p class="inline info">Size: 120 x 40</p>
						<br>	
	...
	<div class="row">
		...
		<div class="col-md-6">
			<div class="row">
                ...
                @endif
				<div class="col-md-6">
					<label for="exampleInputDetails">Project Favicon</label>- <p class="inline info">Size: 35x35</p>	
	...
	<div class="row">
		...
		<div class="col-md-6">
			<label for="wel_email">Contact No:</label>
	...
	<div class="row">
		<div class="col-md-6">
            <label for="cpy_txt">Copyright Text:</label>
            <input value="{{ $setting->cpy_txt }}" name="cpy_txt" placeholder="Enter Copyright Text" type="text" class="{{ $errors->has('cpy_txt') ? ' is-invalid' : '' }} form-control">
		</div>
		<div class="col-md-6">
			<label for="wel_email">Email:</label>
	...
	<div class="row">
		<div class="col-md-6">
			<label for="exampleInputDetails">Address:</label>
	...
	<div class="row">
		<div class="col-md-6">
			...
			<div class="display-inline-flex">
				<label for="">Welcome Email for User: </label>
	...
	<div class="box-footer">
		<button type="Submit" class="btn btn-lg col-md-4 btn-primary"><i class="fa fa-save"></i> Save Setting</button>
	</div>
