        ...
        <div class="col-md-12">
        	<div class="box box-primary">
	           	<div class="box-header with-border">
              		<h3 class="box-title">Payment API</h3>
           		</div>
	          	<div class="panel-body">
	          		<form action="{{ route('api.update') }}" method="POST">
						...
						<div class="row">
							<div class="col-md-12">
		                        <label for="s_enable">STRIPE PAYMENT</label>
		                        ...
		                        <div class="row" style="{{ $gsetting->stripe_enable==1 ? '' : 'display:none' }}" id="s_sec">
		                          <div class="col-md-6">
				                    <label for="STRIPE_KEY">Stripe Key<sup class="redstar">*</sup></label>
				                    <input value="{{ $env_files['STRIPE_KEY'] }}" autofocus name="STRIPE_KEY" type="text" class="form-control" placeholder="Enter Stripe Key"/>
				                    <br>
				                  </div>

				                  <div class="col-md-6">
				                    <label for="s_secretkey">Stripe Secret Key<sup class="redstar">*</sup></label>
						...
						<br>
		              	...
		              	<div class="row">
							<div class="col-md-12">
		                        <label for="pay_enable">PAYPAL PAYMENT</label> 
		                        <li class="tg-list-item">
		                        ...
		                        <div class="row" style="{{ $gsetting->paypal_enable==1 ? '' : 'display:none' }}" id="pay_sec">
					                <div class="col-md-6">
					                    <label for="pay_cid">Paypal Client ID<sup class="redstar">*</sup></label>
					                ...
					                <div class="col-md-6">
					                    <label for="pay_sid">Paypal Secret ID<sup class="redstar">*</sup></label>
				                  	...
				                  	<div class="col-md-6">
				                    	<label for="pay_mode">Paypal Mode<sup class="redstar">*</sup></label>
						...
						<div class="row">
							<div class="col-md-12">
		                        <label for="pay_enable">INSTAMOJO PAYMENT</label> 
		                        <li class="tg-list-item">
		                        ...
		                        <div class="row" style="{{ $gsetting->instamojo_enable==1 ? '' : 'display:none' }}" id="insta_sec">
					                <div class="col-md-6">
					                    <label for="pay_cid">InstaMojo Api Key<sup class="redstar">*</sup></label>
					                ...
					                <div class="col-md-6">
					                    <label for="pay_sid">InstaMojo Auth Token <sup class="redstar">*</sup></label>
				                  	...
				                  	<div class="col-md-6">
				                    	<label for="pay_mode">InstaMojo URL<sup class="redstar">*</sup></label>
						...
						<div class="row">
							<div class="col-md-12">
		                        <label for="razorpay_enable">RAZORPAY PAYMENT</label>
		                        <li class="tg-list-item">
		                        ...
		                        <div class="row" style="{{ $gsetting->razorpay_enable==1 ? '' : 'display:none' }}" id="razor_sec">
		                          <div class="col-md-6">
				                    <label for="RAZORPAY_KEY">Razorpay Key<sup class="redstar">*</sup></label>
				                  ...
				                  <div class="col-md-6">
				                    <label for="RAZORPAY_SECRET">Razorpay Secret Key<sup class="redstar">*</sup></label>
						...
						<br>
		              	...
		              	<div class="row">
							<div class="col-md-12">
		                        <label for="paystack_enable">PAYSTACK PAYMENT</label>
		                        <li class="tg-list-item">
		                        ...
		                        <div class="row" style="{{ $gsetting->paystack_enable==1 ? '' : 'display:none' }}" id="paystack_sec">
		                          <div class="col-md-6">
				                    <label for="RAZORPAY_KEY">PayStack Public Key<sup class="redstar">*</sup></label>
				                  ...
				                  <div class="col-md-6">
				                    <label for="RAZORPAY_SECRET">PayStack Secret Key<sup class="redstar">*</sup></label>
		                          ...
		                          <div class="col-md-6">
				                    <label for="RAZORPAY_KEY">PayStack Payment Url<sup class="redstar">*</sup></label>
				                  ...
				                  <div class="col-md-6">
				                    <label for="RAZORPAY_SECRET">PayStack Merchant Email<sup class="redstar">*</sup></label>
						...
						<div class="row">
							<div class="col-md-12">
		                        <label for="s_enable">PAYTM PAYMENT</label>
		                        <li class="tg-list-item">
		                        ...
		                        <div class="row" style="{{ $gsetting->paytm_enable==1 ? '' : 'display:none' }}" id="paytm_sec">
		                          ...
		                          <div class="col-md-6">
		                          	<div class="form-group">
					                    <label for="PAYTM_ENVIRONMENT">Paytm Enviroment<sup class="redstar">*</sup></label>
				                  ...
				                  <div class="col-md-6">
				                  	<div class="form-group">
					                    <label for="PAYTM_MERCHANT_ID">Paytm Merchant ID<sup class="redstar">*</sup></label>
				                  ...
				                  <div class="col-md-6">
				                  	<div class="form-group">
					                    <label for="PAYTM_MERCHANT_KEY">Paytm Merchant Key<sup class="redstar">*</sup></label>
				                  ...
				                  <div class="col-md-6">
				                  	<div class="form-group">
					                    <label for="PAYTM_MERCHANT_WEBSITE">Paytm Merchant Website<sup class="redstar">*</sup></label>
				                  ...
				                  <div class="col-md-6">
				                  	<div class="form-group">
					                    <label for="PAYTM_CHANNEL">Paytm Channel<sup class="redstar">*</sup></label>
				                  ...
				                  <div class="col-md-6">
				                  	<div class="form-group">
					                    <label for="PAYTM_INDUSTRY_TYPE">Paytm Industry Type<sup class="redstar">*</sup></label>
