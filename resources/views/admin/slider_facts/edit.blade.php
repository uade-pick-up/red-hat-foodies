    ...
    <div class="col-xs-12">
    	<div class="box box-primary">
         	<div class="box-header with-border">
          	<h3 class="box-title">Slider Facts</h3>
       		</div>
        	<div class="panel-body">
              ...
              {{ csrf_field() }}
                ...
                <div class="row">
                  <div class="col-md-4">
                    <label for="icon">Facts Icon<sup class="redstar">*</sup></label>
                  ...
                  <div class="col-md-4">
                    <label for="heading">Facts Heading<sup class="redstar">*</sup></label>
                    <input value="{{ $show->heading }}" autofocus required name="heading" type="text" class="form-control" placeholder="Enter Facts Heading"/>
                  </div>

                  <div class="col-md-4">
                    <label for="sub_heading">Facts Sub Heading<sup class="redstar">*</sup></label>
