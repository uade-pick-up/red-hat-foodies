        ...
        <div class="box-body">
          <div class="form-group">
            <form id="demo-form2" method="post" action="{{action('SliderfactsController@store')}}"vdata-parsley-validate 
              ...
              <div class="row">
                <div class="col-md-4">
                  <label for="icon">Icon:<sup class="redstar">*</sup></label>
                ...
                <div class="col-md-4">
                  <label for="sub_heading">Sub Heading:<sup class="redstar">*</sup></label>
              ...
              <div class="box-footer">
                <button type="submit" value="Add Slider" class="btn btn-md col-md-2 btn-primary">+ Add Facts</button>
              </div>
