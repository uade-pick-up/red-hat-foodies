  	...
  	<div class="row">
        <div class="col-md-12">
        	<div class="box box-primary">
              	...
              	<h3 class="box-title">Course Text</h3>
           		</div>
	          	<div class="panel-body">
	          		<form action="{{ action('CoursetextController@update') }}" method="POST" enctype="multipart/form-data">
		                ...
		                {{ method_field('PUT') }}
		              	...
		              	<div class="row">
		                  <div class="col-md-6">
		                    <label for="heading">Course Text Heading<sup class="redstar">*</sup></label>
		                    <input value="{{ $show['heading'] }}" autofocus required name="heading" type="text" class="form-control" placeholder="Enter Facts Heading"/>
		                  </div>
		              	
		                  <div class="col-md-6">
		                    <label for="sub_heading">Course Text Sub Heading<sup class="redstar">*</sup></label>
