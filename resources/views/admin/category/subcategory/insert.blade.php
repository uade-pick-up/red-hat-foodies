            ...
            <form id="demo-form2" method="post" action="{{url('subcategory/')}}" data-parsley-validate class="form-horizontal form-label-left" autocomplete="off">
              ...
              <div class="row">
                ...
                <div class="col-md-5">
                  <label for="exampleInputTit1e">Category</label>
                  <br>
                  <button type="button" data-dismiss="modal" data-toggle="modal" data-target="#myModal9" title="AddCategory"  class="btn btn-md btn-primary col-md-5">Add</button>
                </div>
              </div>
              <br>
              <div class="row">
                <div class="col-md-6">
                  <label for="exampleInputTit1e">Subcategory:<sup class="redstar">*</sup></label>
              ...
              <div class="box-footer">
                <button type="submit" class="btn btn-lg col-md-3 btn-primary">Add Sub Category</button>
              </div>
