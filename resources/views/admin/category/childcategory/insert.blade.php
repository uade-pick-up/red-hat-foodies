    ...
    <div class="col-xs-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Add New Child Category</h3>
        </div>
        <div class="box-body">
          <div class="form-group">
            <form id="demo-form2" method="post" action="{{url('childcategory/')}}" data-parsley-validate class="form-horizontal form-label-left" autocomplete="off">
              ...
              <div class="row">
                <div class="col-md-5">
                  <label for="exampleInputTit1e">Category</label>
                ...
                <div class="col-md-5">
                  <label for="exampleInputTit1e">Sub Category</label>
                  <select name="subcategories" id="upload_id" class="form-control js-example-basic-single col-md-7 col-xs-12">
                  </select>
                </div>

                <div class="col-md-2">
                  <label for="exampleInputTit1e">Subcategory</label>
                  <br>
                  <button type="button" data-dismiss="modal" data-toggle="modal" data-target="#myModal7" title="AddCategory" class="btn btn-md btn-primary">Add</button>
                </div>
              </div>
              <br>       
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <label for="exampleInputTit1e">Icon:<sup class="redstar">*</sup></label>
