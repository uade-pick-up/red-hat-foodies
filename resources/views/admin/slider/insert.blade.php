        ...
        <div class="box-body">
          <div class="form-group">
            <form id="demo-form2" method="post" action="{{url('slider/')}}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-md-6">
                  <label for="exampleInputTit1e">Heading:<sup class="redstar">*</sup></label>
                  <input class="form-control" type="text" name="heading" placeholder="Please Enter Your Heading">
                </div>
                <div class="col-md-6">
                  <label for="exampleInputSlug">Sub Heading:<sup class="redstar">*</sup></label>
              ...
              <div class="row">
                <div class="col-md-6">
                  <label for="exampleInputTit1e">Search Text:<sup class="redstar">*</sup></label>
              ...
              <div class="row">
                <div class="col-md-6">
                  <label for="exampleInputSlug">Slider Image</label>
                  <br>
              ...
              <div class="box-footer">
                <button type="submit" value="Add Slider" class="btn btn-md col-md-2 btn-primary">+ Add Slider</button>
              </div>
