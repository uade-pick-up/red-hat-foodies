...
<head>
  ...
  <link rel="stylesheet" href="{{ 'admin/plugins/pace/pace.min.css' }}"> <!-- PACE -->
...
<body class="hold-transition skin-blue sidebar-mini fixed">
      ...
      <nav class="navbar navbar-static-top">
        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
            ...
            <li><a href="{{ url('/') }}" target="_blank" class="visit site" style="color: white">Visit Site</a></li>
  ...
  <!-- CK Editor -->
  <script src="{{ URL::asset('admin/bower_components/bootstrap-daterangepicker/daterangepicker.js')}}"></script> <!-- bootstrap datepicker -->
