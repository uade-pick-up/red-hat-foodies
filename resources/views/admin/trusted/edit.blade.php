    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Update Trusted</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <div class="form-group">
            ...
            "data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-md-12">
                  <label for="exampleInputTit1e">Trusted Url:</label>
              ...
              <div class="box-footer">
                <button type="submit" class="btn btn-md col-md-2 btn-primary">Update</button>
              </div>
            </form>
          </div>
        </div>
