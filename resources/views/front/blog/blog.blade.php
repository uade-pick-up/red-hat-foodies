...
<section id="blog-home" class="blog-home-main-block">
    <div class="container">
        <h1 class="blog-home-heading text-white">Blog</h1>
    </div>
</section> 
<!-- about-home end --> 
<!-- blog start -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-md-8">
                                    <div class="blog-slider-dtl">
                                        ...
                                        <p class="btm-10">{{ strip_tags(str_limit($item->detail, $limit = 400, $end = '...')) }}</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                <div class="block-block-dtl">
                                    ...
                                    <p>{{ strip_tags(str_limit($blog->detail, $limit = 400, $end = '...')) }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
