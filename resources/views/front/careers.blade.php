...
<section id="careers-video" class="careers-video-main-block">
    <div class="container">
        <div class="careers-video">
            ...
            <div class="careers-video-icon">
                <a href="#" title="careers"><i class="fa fa-play"></i></a>
            </div>
        </div>
    </div>
</section>
...
@endif
<!-- careers-learn end -->
<!-- udemy-learn-img start-->
@if($data['four_enable'] == 1)
<section id="udemy-learn-img" class="udemy-learn-img-main-block">
    <div class="container-fluid">
        <div class="udemy-learn-img-block">
