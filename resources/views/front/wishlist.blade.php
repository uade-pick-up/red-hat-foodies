        	...
        	@if($wish->user_id == Auth::User()->id)
                <div class="col-lg-3 col-sm-6 col-md-4">
                    <div class="view-block">
                        <div class="view-img">
                            <a href="{{ route('user.course.show',$wish->courses->id) }}"><img src="{{ asset('images/course/'.$wish->courses->preview_image) }}" class="img-fluid" alt="student">
                            </a>
                        </div>
                        <div class="view-dtl">
                            <div class="view-heading btm-10"><a href="{{ route('user.course.show',$wish->courses->id) }}">{{ str_limit($wish->courses->title, $limit = 35, $end = '...') }}</a></div>
...
@else
    <section id="search-block" class="search-main-block search-block-no-result text-center">
        <div class="container">
            <div class="no-result-courses btm-10">Your Wishlist is empty !</div>
            <div class="recommendation-btn text-white text-center">
                <a href="{{ url('/') }}" class="btn btn-primary" title="search"><b>Browse courses now</b></a>
            </div> 
        </div>
    </section>
@endif
