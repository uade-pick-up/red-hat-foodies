...
<section id="wishlist-home" class="wishlist-home-main-block">
    <div class="container">
        <h1 class="wishlist-home-heading text-white">My Course</h1>
    </div>
</section> 
<!-- about-home end -->
@php
...
@else
    <section id="no-result-block" class="no-result-block">
        <div class="container">
            <div class="no-result-courses">When you enroll in a course, it will appear here.&nbsp;<a href="{{ url('/') }}"><b>Browse Now</b></a></div>
        </div>
    </section>
@endif
