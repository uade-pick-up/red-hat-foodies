...
<section id="wishlist-home" class="wishlist-home-main-block">
    <div class="container">
        <h1 class="wishlist-home-heading text-white">Checkout</h1>
    </div>
</section> 
<!-- about-home end -->
		...
		<div class="cart-items btm-30">
	        <div class="row">
	        	<div class="col-lg-4 col-sm-4">
	        		<h4 class="cart-heading">Your Items
            		(@php
	            		...
	            		@foreach($carts as $cart)
			            	<div class="row btm-10">
			            		<div class="col-lg-3 col-4">
			            			<div class="checkout-course-img"><a href="{{ route('user.course.show',$cart->courses->id) }}"><img src="{{ asset('images/course/'. $cart->courses->preview_image) }}" class="img-fluid" alt="course"></a></div>
			            		</div>
			            		<div class="col-lg-9 col-8">
			            			<ul>
			            				<li class="checkout-course-title"><a href="{{ route('user.course.show',$cart->courses->id) }}">{{ str_limit($cart->courses->title, $limit =35 , $end = '...') }}</a></li>
	            ...
	            <div class="col-lg-8 col-sm-8">
	            	<div class="checkout-pricelist">
		            	<ul>
		            		<li><h1 class="checkout-total">Total: <i class="{{ $currency->icon }}"></i>{{ $cart_total }}</h1></li>
	            		...
	            		<div id="accordion" class="second-accordion">
						    ...
						    <div class="card">
							    ...
							    <div id="collapseOne" class="panel-collapse collapse in">
							        <div class="card-body">
		                            	...
		                            	<p>Unfortunately, Paypal does not process payments in INR. Your purchase will be made in USD.</p>
							...
							<div class="card">
							    ...
							    <div id="collapseThree" class="panel-collapse collapse in">
							        <div class="card-body">
								        <p>Unfortunately, Stripe does not process payments in INR. Your purchase will be made in USD.</p>
									    <div class="creditCardForm">
										    ...
										    <div class="payment">
										        <form accept-charset="UTF-8" action="{{route('stripe.pay')}}" method="POST"autocomplete="off">
										            ...
										            <button class='form-control btn btn-default' type='submit'>Pay »</button>
										        </form>
										    </div>
										</div>
							        </div>
