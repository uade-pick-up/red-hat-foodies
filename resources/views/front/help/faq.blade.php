...
<section id="help" class="help-main-block">
    <div class="container">
        <h1 class="help-heading text-white text-center">How may we help you?</h1>
                        ...
                        <div class="col-lg-4">
                            <div class="categories-block help-tab-one text-center">
                                ...
                                <ul>
                                    ...
                                    <li class="btm-5"><span>Purchase History</span></li>
                            ...
                            <div class="categories-block help-tab-one text-center">
                                @if(Auth::check())
                                    ...
                                    <ul>
                                        ...
                                        <li class="btm-5"><span>Account/Profile</span></li>
                            ...
                            <div class="categories-block help-tab-one text-center">
                                @if(Auth::check())
                                    ...
                                    <ul>
                                        ...
                                        <li class="btm-5"><span>Become An Instructor</span></li>
                                        <li>To Become An Online Instructot</li>
                                    </ul>
                                    </a>
                                @else
                                    <a href="{{ route('login') }}">
