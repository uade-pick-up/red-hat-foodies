        ...
        <div id="business-home-slider-two" class="business-home-slider owl-carousel">
            ...
            <div class="item business-home-slider-block">
                <div class="business-home-slider-img">
                    <a href="{{ route('user.course.show',$course->id) }}"><img src="{{ asset('images/course/'.$course->preview_image) }}" class="img-fluid" alt="student"></a>
                </div>
                <div class="categories-popularity-dtl">
                    ...
                    <div class="view-heading btm-10"><a href="{{ route('user.course.show',$course->id) }}">{{ str_limit($course->title, $limit=50)}}</a></div>
                    ...
                    <p class="btm-20">{{ str_limit($course->short_detail, $limit = 100, $end='...') }}</p>
                    <div class="business-home-slider-btn btm-20">
                        <a href="{{ route('user.course.show',$course->id) }}" type="button" class="btn btn-info">Explore course</a>
                    </div>
                </div>
            </div>
            @endif
                    ...
                    <div class="item testimonial-block text-center btm-30">
                        <div class="instructors-img-block btm-20">
                            @if($user->user->user_img != null || $user->user->user_img !='')
                                <img src="{{ asset('images/user_img/'.$user->user->user_img) }}" alt="blog">
                            @else
