...
@endif
<!-- about-team start-->
<!-- about-udemy-blog start-->
@if($about['six_enable'] == 1)
<section id="about-udemy-blog" class="about-udemy-blog-main-block btm-40">
    <div class="container">
        <h1 class="about-udemy-blog-heading text-white text-center btm-40">{{ $about->six_heading }}</h1>
        <div class="about-udemy-blog-block">
            <div class="row">
                <div class="col-lg-4">
                    <div class="about-udemy-blog-dtl text-white btm-20">
                        <h3 class="about-udemy-blog-dtl-heading text-white">{{ $about->six_txtone }}</h3>
                        <div class="row">
                            <div class="col-lg-10 col-9">
                                <div class="about-udemy-blog-paragraph">
                                    <p>{{ str_limit($about->six_deatilone, $limit = 100, $end = '...') }}</p>
                                </div>
                            </div>
                            <div class="col-lg-2 col-3">
                                <div class="about-udemy-blog-icon lft-7">
                ...
                <div class="col-lg-4">
                    <div class="about-udemy-blog-dtl text-white btm-20">
                        <h3 class="about-udemy-blog-dtl-heading text-white">{{ $about->six_txttwo }}</h3>
                        <div class="row">
                            <div class="col-lg-10 col-9">
                                <div class="about-udemy-blog-paragraph lft-7">
                                    <p>{{ str_limit($about->six_deatiltwo, $limit = 100, $end = '...') }}</p>
                                </div>
                            </div>
                            <div class="col-lg-2 col-3">
                                <div class="about-udemy-blog-icon">
                                    <i class="fa fa-chevron-right"></i>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="about-udemy-blog-dtl text-white">
                        <h3 class="about-udemy-blog-dtl-heading text-white">{{ $about->six_txtthree }}</h3>
                        <div class="row">
                            <div class="col-lg-10 col-9">
                                <div class="about-udemy-blog-paragraph">
