		...
		<div class="row">
			...
			<div class="col-lg-3">
				<div class="class-button">
					<ul>
						<li>
							<a href="{{ route('mycourse.show') }}" class="course_btn"> <i class="fa fa-chevron-left"></i> My courses</a>
						</li>
						<li>
							<a href="{{ route('user.course.show',$courses->id) }}" class="course_btn"> Course details <i class="fa fa-chevron-right"></i></a>
						</li>
					</ul>
				</div>
			</div>
