            ...
            <div class="item immi-slider-block development">
                <div class="genre-slide-image protip" data-pt-placement="outside" data-pt-interactive="false" data-pt-title="#prime-next-item-description-block{{$c->id}}">
                    <div class="view-block">
                        <div class="view-img">
                            <a href="{{ route('user.course.show',$c->id) }}"><img src="{{ asset('images/course/'.$c->preview_image) }}" alt="course"class="img-fluid" >
                            </a>
                        </div>
                        <div class="view-dtl">
                            <div class="view-heading btm-10"><a href="{{ route('user.course.show',$c->id) }}">{{ str_limit($c->title, $limit = 35, $end = '...') }}</a></div>
...
@if($count >= 3)
    <div class="view-button txt-rgt">
        <a href="{{ route('category.page',$cats->id) }}" class="btn btn-secondary" title="View More">View More</a>
    </div>
@endif