                    ...
                    <div class="col-lg-2 col-md-2 col-sm-12">
                        <div class="logo">
                            ...
                            @if($setting->logo_type == 'L')
                                <a href="{{ url('/') }}" title="logo"><img src="{{ asset('images/logo/'.$setting->logo) }}" class="img-fluid" alt="logo"></a>
                            @else()
            ...
            <div class="col-lg-6">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="udemy-business">
                            @if($setting->instructor_enable == 1)
                                <a href="{{ route('login') }}" class="btn btn-link" data-toggle="tooltip" data-placement="bottom" title="Login/Register To Become an Instructor">Become An Instructor</a>
                            @endif
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="Login-btn">
                            <a href="{{ route('register') }}" class="btn btn-primary" title="register">Sign Up</a>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-6">
                        <div class="udemy-business">
                            @if(Auth::User()->role == "user")
                                @if($setting->instructor_enable == 1)
                                    <a href="#" class="btn btn-link" data-toggle="modal" data-target="#myModalinstructor" title="Become An Instructor">Become an instructor</a>
                                @endif
                            @endif
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-2 col-6">
                        <div class="udemy-business">
                            <a href="{{ route('mycourse.show') }}" class="btn btn-link" title="My Course">My Course</a>
                        </div>
                    </div>
                        ...
                        <div class="nav-wishlist">
                            <ul id="nav">
                                <li id="notification_li">
                                    ...
                                    <div id="notificationFooter"><a href="{{route('deleteNotification')}}">Clear All</a></div>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="my-container">
                          <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right User-Dropdown U-open" aria-labelledby="dropdownMenu1">
                                ...
                                <a target="_blank" href="{{ url('/admins') }}"><li><i class="fa fa-dashboard"></i>Admin Dashboard</li></a>
                                @endif
                                <a href="{{ route('mycourse.show') }}"><li><i class="fa fa-diamond"></i>My Courses</li></a>
                                <a href="{{ route('wishlist.show') }}"><li><i class="fa fa-heart"></i>My Wishlist</li></a>
                                <a href="{{ route('purchase.show') }}"><li><i class="fa fa-shopping-cart"></i>Purchase History</li></a>
                                <a href="{{route('profile.show',Auth::User()->id)}}"><li ><i class="fa fa-user"></i>User Profile</li></a>
                                @if(Auth::User()->role == "user")
                                @if($gsetting->instructor_enable == 1)
                                <a href="#" data-toggle="modal" data-target="#myModalinstructor" title="Become An Instructor"><li><i class="fas fa-chalkboard-teacher"></i>Become an instructor</li></a>
                                @endif
